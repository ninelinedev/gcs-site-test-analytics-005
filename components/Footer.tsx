    ...
    <footer className="bg-primary-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent-500">Unlock Your Business Insights with Test-Analytics-005</h3>
        ...
        <div className="border-t border-primary-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Unlock Your Business Insights with Test-Analytics-005. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
